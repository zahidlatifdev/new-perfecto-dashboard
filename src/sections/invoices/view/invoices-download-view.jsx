...
const SAVED_REPORTS = [
    { id: 1, name: 'Monthly Invoice Summary', format: 'xlsx', lastRun: 'June 10, 2025' },
    { id: 2, name: 'Quarterly Sales Report', format: 'pdf', lastRun: 'May 22, 2025' },
    { id: 3, name: 'Invoice Data for Accounting', format: 'csv', lastRun: 'June 5, 2025' },
];
...
export function InvoicesDownloadView() {
    ...
    const handleDownload = () => {
        ...
        setTimeout(() => {
            ...
            link.download = `invoices-report-${new Date().toISOString().split('T')[0]}.${format}`;
    ...
    const handleViewInvoices = () => {
        router.push('/dashboard/invoices/view');
    };
    ...
    return (
        <DashboardContent>
            <Typography variant="h4" sx={{ mb: 2 }}>
                Download Invoices Data
            </Typography>

            <Typography variant="body1" sx={{ mb: 4 }}>
                Download your processed invoice data in various formats. Apply filters to customize your report.
            </Typography>
            ...
            <Grid container spacing={4}>
                <Grid item xs={12} lg={8}>
                        ...
                        <Stack spacing={3}>
                            ...
                            <FormGroup row>
                                ...
                                <FormControlLabel
                                    control={
                                        <Checkbox
                                            checked={filters.paypalInvoices}
                                            onChange={handleFilterChange}
                                            name="paypalInvoices"
                                        />
                                    }
                                ...
                                <FormControlLabel
                                    control={
                                        <Checkbox
                                            checked={filters.manualInvoices}
                                            onChange={handleFilterChange}
                                            name="manualInvoices"
                                        />
                                    }
                    ...
                    <Alert severity="success" sx={{ mb: 4 }} icon={<Iconify icon="ph:chart-line-up-bold" />}>
                        <AlertTitle>Business Analytics</AlertTitle>
                        Download your invoice data for business analytics, accounting software integration, and financial reporting.
                ...
                <Grid item xs={12} lg={4}>
                    ...
                    <Alert severity="info" sx={{ mb: 2 }}>
                        ...
                        Contact our support team to set up custom reporting needs for your business invoicing.
                    </Alert>
                </Grid>
            </Grid>
