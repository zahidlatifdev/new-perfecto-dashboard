...
export function InvoicesUploadView() {
    ...
    return (
        <DashboardContent>
            ...
            <Typography variant="body1" sx={{ mb: 4 }}>
                Upload your invoices for automatic processing. Supported formats: PDF, PNG, JPG. Maximum size: 20MB per file.
            </Typography>
            ...
            {uploadSuccess && (
                ...
                >
                    ...
                    Your invoices have been processed successfully. Redirecting to view invoices...
                </Alert>
            )}
            ...
            <Card sx={{ p: 3, mb: 4 }}>
                ...
                <Stack spacing={2}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <Iconify icon="ph:check-circle-bold" sx={{ color: 'success.main', mr: 2 }} />
                        <Typography variant="body2">
                            Invoice number, date, and amount detection
                        </Typography>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <Iconify icon="ph:check-circle-bold" sx={{ color: 'success.main', mr: 2 }} />
            ...
            >
                ...
                For best results, ensure invoices are clear and high-resolution. Our AI can process both digital and scanned invoices.
            </Alert>
